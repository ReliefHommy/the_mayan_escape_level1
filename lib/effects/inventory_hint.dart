...
class InventoryHint extends StatefulWidget {
  const InventoryHint({super.key});

  @override
  State<InventoryHint> createState() => _InventoryHintState();
}

class _InventoryHintState extends State<InventoryHint>
          ...
          Center(
            child: AnimatedOpacity(
              ...
              child: Container(
                ...
                child: Text(
                  "Hint: Ceremonial Dagger: To cutting the Vines.",
                  style: hintTextStyle,
                ),
              ),
            ),
