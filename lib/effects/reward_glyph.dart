...
class RewardGlyph extends StatefulWidget {
  const RewardGlyph({super.key});

  @override
  State<RewardGlyph> createState() => _RewardGlyphState();
}

class _RewardGlyphState extends State<RewardGlyph>
          ...
          Center(
            child: AnimatedOpacity(
              ...
              child: Container(
                ...
                child: const Text(
                  "You have Un Lock The Water Offering Ritual!",
