...
class RewardRotating extends StatefulWidget {
  const RewardRotating({super.key});

  @override
  State<RewardRotating> createState() => _RewardRotatingState();
}

class _RewardRotatingState extends State<RewardRotating>
